...
//
// The leading entry's `ver` field reads `window.WHETSTONE_VERSION`
// (set in src/version.js, regenerated by `just release` from the
// repo-root VERSION file). Older entries are historical and frozen.
// Phase 2.5: removed hardcoded `2.2.2` from the source-of-truth slot.
// ============================================================
const RELEASES = [
  {
    ver: window.WHETSTONE_VERSION,
    date: '2026-06-07',
    title: 'v3 phase 2 — bug fixes + VERSION single source of truth',
    bullets: [
      'wrapper: drop hardcoded --model injection (Claude Code owns model selection)',
      'rtk: raise MIN_VERSION floor to 0.42.0 (contract-pinned)',
      'update: --full now actually forces dependency refresh',
      'site: WHETSTONE_VERSION pulled from VERSION at release time',
      'remove model-upgrade prompt + dismissal-file machinery',
    ],
    stats: [
      { v: 'VERSION', l: 'SOURCE OF TRUTH' },
      { v: '0', l: 'HARDCODED VER STRINGS' },
      { v: '+8', l: 'REGRESSION TESTS' },
    ],
  },
  {
    ver: '2.2.2',
